...
// sanitize players -> plain JSON (no functions, no circular refs)
...
server.listen(PORT, () => console.log('Server listening on  http://localhost:3000 ', PORT));
